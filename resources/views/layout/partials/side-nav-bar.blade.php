            ...
            <div class="row">
                ...
                <div class="panel-body" style="margin-top: -8%;">
                    <div class="row" style="margin-top: 2%; margin-left: -1.2%; margin-bottom: 8%">
                        ...
                        <a class="text-uppercase" style="color:  #ff432e;" href="{{ route('show-all-category') }}">All</a>
                    </div>
                    @foreach ($categories as $category)
                     <div class="panel-body" style="margin-top: -5%;">
                        <i style="width: 20em;" class="devicon-{{ strtolower($category->name) }}-plain colored"></i>
                        <a class="text-uppercase" style="color:  #ff432e;" href="/category/{{ $category->id }}/videos">{{ $category->name }}</a>
                      </div>
                    @endforeach
                </div>
            </div>
