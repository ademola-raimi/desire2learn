                            ...
                            <div class="card-deck sidebar-inner">
                                <div class="card" >
                                    ...
                                    <div class="card-block" >
                                        ...
                                        <span class="pull-right" style="margin-top: -15%; margin-right: -5%;"><a href="{{ route('delete-video', ['id' => $video->id]) }}" class="delete-video"><button class="btn btn-primary btn-flat" style="width: 60px;">Delete</button></a></span>

                                        <span class="pull-right" style="margin-right: 25%; margin-top: -15%;"><a href="/video/edit/{{ $video->id }}"><button class="btn btn-primary btn-flat" style="width: 60px;">Edit</button></a></span>
                                    </div>
                                </div>
                            </div>
                        </div>
